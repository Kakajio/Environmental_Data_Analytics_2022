...
NTL.phys.data.surface <- filter(NTL.phys.data, year4 == 1999)

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
NTL.phys.data.LAKE <-filter(NTL.phys.data, lakename=="Tuesday Lake", year(sampledate) %in% c(1990:1999))
View(NTL.phys.data.LAKE)
```
...
NTL.phys.data.July <- 
  ...
  filter(year4 %in% c(1990:1999), month(sampledate)== 07)
