...
Cplot<- ggplot(subset(PeterPaul.chem.nutrients, depth == 0), 
...
#Cplot <- ggplot(PeterPaul.chem.nutrients, subset(depth=0), aes(x = sampledate, y = temperature_C, color= year4)) +
 # geom_point() +
  #facet_wrap (vars(lakename), nrow = 2)
#print(Cplot)
```
...
Dplot<- ggplot(PeterPaul.chem.nutrients, 
...
AQI<- ggplot(EPAair, 
         aes(x = PM2.5, y = Ozone, color= meanLat)) + 
