...
```{r}
#5 
student_name <- c("Lily","Bily","Cici","Andy") #names of students
test_score<-c(51, 55, 52, 50) # test scores out of a total 100 points
test_score>=50
...
> Answer: ifelse worked, but if and else no. Becuasue ifelse can be used to treat vector, but if and else cannot. 
